...
export default function ArticleMenu() {
    ...
    const tabs = [{
        ...
        id: 'tab2',
        title: '社媒',
        content: <CategoryCardGroup categoryTitle="社交媒体类" cards={socialMediaCards}/>
    }, {id: 'tab3', title: '工作', content: <CategoryCardGroup categoryTitle="工作类" cards={workCards}/>}, {
        id: 'tab4',
        title: '视频',
        content: <CategoryCardGroup categoryTitle="短视频类" cards={shortVideoCards}/>
    }, {
        id: 'tab5',
        title: '电商',
        content: <CategoryCardGroup categoryTitle="电商类" cards={ecommerceCards}/>
