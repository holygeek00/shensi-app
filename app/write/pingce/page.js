                ...
                <div className="w-full max-w-3xl bg-white rounded-lg shadow-xl p-6">
                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-4">
                        <div>
                            ...
                            <input type="text" name="productName" placeholder="真丝阔腿裤"
                                   className="input input-bordered w-full" value={formData.productName}
                                   onChange={handleFormInputChange}/>
                        </div>
                        <div>
                            <label className="text-gray-700">产品特点*</label>
                            <textarea name="productFeatures" placeholder="质地柔软 版型好"
                                      className="textarea textarea-bordered w-full" value={formData.productFeatures}
                                      onChange={handleFormInputChange}/>
                        </div>
