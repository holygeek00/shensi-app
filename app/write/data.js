...
export const educationLiteratureCards = [{
  title: "小学生作文写作",
...
export const AiDrawer = [
  {
    title: "Dall-E 2",
    text: "Dall-E 2 是一个由 OpenAI 开发的人工智能模型，它可以根据用户输入的文本生成相应的图像。",
    imageUrl: "/dall-e2.png",
    link: './dalle'
  }
]
...
export const AiChat = [
    {
      title: "ChatGPT",
      text: "ChatGPT 是一个由 OpenAI 开发的人工智能聊天机器人，它可以与用户进行自然语言对话，回答问题并提供建议。",
      imageUrl: "https://ts2.cn.mm.bing.net/th?id=ODLS.0dc18014-3388-4dd0-af06-c7b7a1d04d8f&w=32&h=32&qlt=92&pcl=fffffa&o=6&pid=1.2",
      link: './talk'
    }
]