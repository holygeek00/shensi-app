...
const chatStreamText = async (req) => {
    try {
        ...
        const updateResult = await execSql('UPDATE users SET quota = $1 WHERE phone_number = $2', [user.quota - totalTokens - messageToken, user.phone_number]);
